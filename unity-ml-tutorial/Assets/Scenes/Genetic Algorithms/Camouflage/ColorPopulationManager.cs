...
public class ColorPopulationManager : MonoBehaviour
{
    ...
    void Start()
    {
        for (int i = 0; i < populationSize; i++)
        {
            ...
            go.GetComponent<ColorDna>().r = Random.Range(0.0f, 1.0f);
            go.GetComponent<ColorDna>().g = Random.Range(0.0f, 1.0f);
            go.GetComponent<ColorDna>().b = Random.Range(0.0f, 1.0f);
            population.Add(go);
        }
    }
    ...
    public void BreedNewPopulation()
    {
        ...
        List<GameObject> sortedList = population.OrderBy(o => o.GetComponent<ColorDna>().timeToDie).ToList();
    ...
    public GameObject Breed(GameObject parent1, GameObject parent2)
    {
        ...
        {
            offspring.GetComponent<ColorDna>().r = Random.Range(0, 10) < 5 ? dna1.r : dna2.r;
            offspring.GetComponent<ColorDna>().g = Random.Range(0, 10) < 5 ? dna1.g : dna2.g;
            offspring.GetComponent<ColorDna>().b = Random.Range(0, 10) < 5 ? dna1.b : dna2.b;
        }
        else // mutate 5% of the time
        {
            offspring.GetComponent<ColorDna>().r = Random.Range(0.0f, 1.0f);
            offspring.GetComponent<ColorDna>().g = Random.Range(0.0f, 1.0f);
            offspring.GetComponent<ColorDna>().b = Random.Range(0.0f, 1.0f);
        }
